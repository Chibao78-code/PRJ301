...
public class ExamDAO implements IDAO<ExamDTO, Integer> {
    ...
    public boolean create(ExamDTO entity) {
        ...
        try (Connection conn = DBUtils.getConnection();
            ...
            System.out.println("Error in ExamDAO.create: " + e.toString());
            return false;
        }
    }
    ...
    public List<ExamDTO> readAll() {
        ...
        try (Connection conn = DBUtils.getConnection();
            ...
            System.out.println("Error in ExamDAO.readAll: " + e.toString());
        }
        return list;
    }
    ...
    public ExamDTO readById(Integer id) {
        ...
        try (Connection conn = DBUtils.getConnection();
            ...
            System.out.println("Error in ExamDAO.readById: " + e.toString());
        }
        return null;
    }
    ...
    public boolean update(ExamDTO entity) {
        ...
        try (Connection conn = DBUtils.getConnection();
            ...
            System.out.println("Error in ExamDAO.update: " + e.toString());
            return false;
        }
    }
    ...
    public boolean delete(Integer id) {
        ...
        try (Connection conn = DBUtils.getConnection();
            ...
            System.out.println("Error in ExamDAO.delete: " + e.toString());
            return false;
        }
    }
    ...
    public List<ExamDTO> search(String searchTerm) {
        ...
        try (Connection conn = DBUtils.getConnection();
            ...
            System.out.println("Error in ExamDAO.search: " + e.toString());
        }
        return list;
    }
