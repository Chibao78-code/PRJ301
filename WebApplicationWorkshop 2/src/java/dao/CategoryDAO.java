...
public class CategoryDAO implements IDAO<CategoryDTO, Integer> {
    ...
    public boolean create(CategoryDTO entity) {
        ...
        try (Connection conn = DBUtils.getConnection();
            ...
            System.err.println("Error in CategoryDAO.create: " + e.getMessage());
            return false;
        }
    }
    ...
    public List<CategoryDTO> readAll() {
        ...
        try (Connection conn = DBUtils.getConnection();
            ...
            System.err.println("Error in CategoryDAO.readAll: " + e.getMessage());
        }
        return list;
    }
    ...
    public CategoryDTO readById(Integer id) {
        ...
        try (Connection conn = DBUtils.getConnection();
            ...
            System.err.println("Error in CategoryDAO.readById: " + e.getMessage());
        }
        return null;
    }
    ...
    public List<CategoryDTO> search(String searchTerm) {
        ...
        try (Connection conn = DBUtils.getConnection();
            ...
            System.err.println("Error in CategoryDAO.search: " + e.getMessage());
        }
        return list;
    }
}